...
⚡ Fully automated MCP server built to communicate with JADX-AI-MCP Plugin to analyze Android APKs using LLMs like TRAE — uncover vulnerabilities, parse manifests, and reverse engineer effortlessly.
...
<!--&lt;!-- MCP (Model Context Protocol) server that connects to a custom plugin of [JADX](https://github.com/skylot/jadx) called [JADX-AI-MCP](https://github.com/zinja-coder/jadx-ai-mcp) and provides reverse engineering capabilities directly to local LLMs like TRAE Desktop.--&gt;
...
**JADX-AI-MCP** is a plugin for the [JADX decompiler](https://github.com/skylot/jadx) that integrates directly with [Model Context Protocol (MCP)](https://github.com/anthropic/mcp) to provide **live reverse engineering support with LLMs like TRAE**.
...
#### Note: Tested on TRAE Desktop. Support for other LLMs might be tested in future.
...
│  (TRAE,   │   Where the MCP server │                  │   Where the MCP server looks  │  (jadx-ai-mcp)   │
...
Also huge thanks to the TRAE development team.
